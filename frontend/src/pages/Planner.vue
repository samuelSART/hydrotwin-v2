<template>
    <v-container fluid pa-0 ma-0>
        <v-row>
            ...
            <v-col cols="1">
                <v-btn icon prepend-icon="mdi-download" @click="downloadCSV">
        ...
        <v-row class="ma-2 mb-0">
            ...
            ></v-skeleton-loader>
            <v-col v-if="!skeleton">
                <WaterDeficitChart ref="chartDeficit" :plotData="plotData" />
            </v-col>

            <v-col v-if="!skeleton">
                <CO2EmissionChart ref="chartEmission" :plotData="plotData" />
            </v-col>
            <v-col v-if="!skeleton">
                <HidroEconomicChart ref="chartEconomic" :plotData="plotData" />
            </v-col>
            <v-col v-if="!skeleton">
        ...
        <v-row class="ml-2 mr-2 mt-0" style="margin-bottom:64px;">
            <v-col>
                <PlannerTable
                    v-if="!hiddeTable"
                    ref="plannerTable"
        ...
        <ScenarioAnalysisDiaolog
            ...
            :planDaily="daily"
            :optimizer="false"
            @plan-generator-running="plannerRuning"
        />
    </v-container>
</template>
